...
urlpatterns = [
    ...
    path(
        "vessels/<int:pk>/", VesselDetailView.as_view(), name="vessel-detail"
    ),
    ...
    path(
        ...
        VesselDeleteView.as_view(),
        name="vessel-delete",
    ),
    path(
        "vessels/<int:pk>/toggle-assign/",
        toggle_assign_to_vessel,
        name="toggle-vessel-assign",
    ),
    path(
        "vessel_types/", VesselTypeListView.as_view(), name="vessel-type-list"
    ),
    path(
        "vessel_types/create/",
        VesselTypeCreateView.as_view(),
        name="vessel-type-create",
    ),
    path(
        "vessel_types/<int:pk>/update/",
        VesselTypeUpdateView.as_view(),
        name="vessel-type-update",
    ),
    path(
        "vessel_types/<int:pk>/delete/",
        VesselTypeDeleteView.as_view(),
        name="vessel-type-delete",
    ),
    ...
    path(
        "crew/<int:pk>/update/", CrewUpdateView.as_view(), name="crew-update"
    ),
    path(
        "crew/<int:pk>/delete/", CrewDeleteView.as_view(), name="crew-delete"
    ),
    path("company/", CompanyListView.as_view(), name="company-list"),
    path(
        "company/<int:pk>/", CompanyDetailView.as_view(), name="company-detail"
    ),
    path(
